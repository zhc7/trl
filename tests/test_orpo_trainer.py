...
from trl.trainer.orpo_trainer import _tokenize
...
class ORPOTrainerTester(unittest.TestCase):
    ...
    def test_tokenize_and_process_tokens(self):
        ...
        self.eval_ref = Dataset.from_dict({
            "prompt": [
                "hello",
                "how are you",
                "What is your name?",
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            print(f"train_dataset: {trainer.train_dataset[0]}")
            self.assertEqual(trainer.train_dataset, self.train_ref)
