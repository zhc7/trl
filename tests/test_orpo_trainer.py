    ...
    def test_tokenize_and_process_tokens(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                self.assertListEqual(tokenized_dataset["prompt_input_ids"][0], [31373])
                ...
                self.assertListEqual(processed_dataset["prompt_input_ids"][0], [50256, 31373])
                self.assertListEqual(processed_dataset["prompt_attention_mask"][0], [1, 1])
                self.assertListEqual(processed_dataset["chosen_input_ids"][0], [50256, 5303, 3621, 284, 1826, 345, 50256])
                self.assertListEqual(processed_dataset["chosen_attention_mask"][0], [1, 1, 1, 1, 1, 1, 1])
                self.assertListEqual(processed_dataset["chosen_labels"][0], [50256, 5303, 3621, 284, 1826, 345, 50256])
                self.assertListEqual(processed_dataset["rejected_input_ids"][0], [50256, 47408, 502, 3436, 50256])
                self.assertListEqual(processed_dataset["rejected_attention_mask"][0], [1, 1, 1, 1, 1])
                self.assertListEqual(processed_dataset["rejected_labels"][0], [50256, 47408, 502, 3436, 50256])
